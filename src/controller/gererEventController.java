...
//idevent.setVisible(false);
		...
		sortedData.comparatorProperty().bind(tableEventListe.comparatorProperty());
						...
						if (empty) {
							...
							editBtn.setOnAction((ActionEvent event) -> {
								...
								try {
									...
									System.out.println("selected" + eventselected.getEventName()
											+ eventselected.getEventDescription());
